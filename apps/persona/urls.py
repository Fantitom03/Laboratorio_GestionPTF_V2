...
urlpatterns = [
    ...
    #alumno views
    path('alumno/', views.AlumnoList.as_view(), name='alumno_list'),
    path('alumno/nuevo/', views.AlumnoCreate.as_view(), name='alumno_create'),
    path('alumno/<int:pk>/', views.AlumnoDetail.as_view(), name='alumno_detail'),
    path('alumno_delete/<int:pk>/', views.AlumnoDelete.as_view(), name='alumno_delete'),
    path('alumno_edit/<int:pk>/',views.AlumnoUpdate.as_view(), name='alumno_edit'),
